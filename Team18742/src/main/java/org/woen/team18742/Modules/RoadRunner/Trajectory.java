...
public class Trajectory {
    public static RoadRunnerRouteManager.MyTrajectoryBuilder GetTrajectory(RoadRunnerRouteManager.MyTrajectoryBuilder builder,
        ...
        builder.strafeToLinearHeading(new Vector2d(ToInch(123.9), ToInch(80)), 0);
        builder.liftMiddle();
        builder.waitSeconds(1.6);
        builder.pixelDeGripp();
        //builder.waitSeconds(0.7);
        builder.strafeToLinearHeading(new Vector2d(ToInch(-97.9), ToInch(101)), 0);
        builder.brushOn();
        builder.brushDown();
        builder.strafeToLinearHeading(new Vector2d(ToInch(-146), ToInch(92)), 0);
        builder.waitPixel();
        builder.strafeToLinearHeading(new Vector2d(ToInch(70.9), ToInch(89)), 0);
        builder.strafeToLinearHeading(new Vector2d(ToInch(123.9), ToInch(80)), 0);
        builder.liftMiddle();
