...
public class Trajectory {
    public static RoadRunnerRouteManager.MyTrajectoryBuilder GetTrajectory(RoadRunnerRouteManager.MyTrajectoryBuilder builder,
        ...
        builder.waitPixel();
        builder.strafeToLinearHeading(new Vector2d(ToInch(70.9), ToInch(90)), 0);
        builder.strafeToLinearHeading(new Vector2d(ToInch(117.9), ToInch(80)), 0);
        builder.liftMiddle();
        ...
        builder.brushOn();
        builder.brushDown();
        builder.strafeToLinearHeading(new Vector2d(ToInch(-149.9), ToInch(92)), 0);
        builder.waitPixel();
        builder.strafeToLinearHeading(new Vector2d(ToInch(70.9), ToInch(90)), 0);
        builder.strafeToLinearHeading(new Vector2d(ToInch(117.9), ToInch(80)), 0);
        builder.liftMiddle();
