    ...
    public void runOpMode() {
        ...
        if (pipeLine.pos == 1) {
            robot.updateWhilePositionFalse(new Runnable[]{
                            () -> autnomModules.move(13500, -22000, 0, 1.6),
                            () -> autnomModules.move(0, 22000, 0, 0.5),
                            () -> autnomModules.move(0, 0, -12000, 1),
                            () -> autnomModules.move(5000, -30000, 0, 2.3),
            ...
            robot.updateWhilePositionFalse(new Runnable[]{
                            ...
                            () -> autnomModules.move(0, 0, -12000, 1),
                            () -> autnomModules.move(-6000, -30000, 0, 2.8),
                            () -> autnomModules.bacBoardPixels(),
                            () -> autnomModules.move(0, 30000, 0, 0.5),
            ...
            robot.updateWhilePositionFalse(new Runnable[]{
                            ...
                            () -> autnomModules.move(0, 30000, 0, 0.5),
                            () -> autnomModules.move(0, 0, -12000, 2.1),
                            () -> autnomModules.move(-20000, -30000, 0, 2.4),
                            () -> autnomModules.bacBoardPixels(),
                            () -> autnomModules.move(0, 30000, 0, 0.5)
                    }
            );
