...
@TeleOp
@Config
public class TeleOPFor2Drivers extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            boolean liftUpAuto            = gamepad2.triangle;
            boolean liftDownAuto          = gamepad2.cross;

            boolean brushIn               = gamepad2.left_trigger > 0.1;
            boolean brushOut              = gamepad2.left_bumper;

            boolean openAndFinishGrabber  = gamepad2.circle;
            boolean closeAndSafeGrabber   = gamepad2.square;

            boolean liftUpMan             = gamepad2.dpad_up;
            boolean liftDownMan           = gamepad2.dpad_down;

            boolean openGrabberMun        = gamepad2.dpad_left;
            boolean closeGrabberMun       = gamepad2.dpad_right;

            boolean startPlane            = gamepad2.ps;
            boolean aimPlane              = gamepad2.share;
